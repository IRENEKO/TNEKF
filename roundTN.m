function a=roundTN(a,tol,varargin)
% a=roundTN(a,tol)
% ----------------
...
% 
% 03/2019 Revised by Ching-Yun Ko for 
% 
...
for i=1:d-1
    ...
    r=length(s)-r;
        ...
        if a.n(i,end)<varargin{1}
            ...
            [U,S,V]=svds(reshape(a.core{i},[prod(a.n(i,1:end-1)),a.n(i,end)]),varargin{1});
            s=diag(S);
            r=0;
            while norm(s(end:-1:end-r)) < delta
                r=r+1;
    ...
    a.n(i,end)=r;
    a.core{i+1}=reshape((S(1:r,1:r)*V(:,1:r)')*reshape(a.core{i+1},[a.n(i+1,1),prod(a.n(i+1,2:end))]),[r,(a.n(i+1,2:end-1)),a.n(i+1,end)]);   
    a.n(i+1,1)=r;
end
